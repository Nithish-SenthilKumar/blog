...
<div style={{ textAlign: 'center' }}>
  <Image
    src="/images/Hero_Image.webp" // Replace with your actual image path
    alt="AI Stack of LLMs - Generative AI models recognizing patterns in data and creating original outputs"
    width={600} // Adjust width as needed - MUST BE SET EXPLICITLY
    height={400} // Adjust height as needed - MUST BE SET EXPLICITLY
    style={{ display: 'block', margin: '0 auto' }}
  />
  <p style={{ textAlign: 'center' }}>
    AI Stack of LLMs - Generative AI models recognizing patterns in data and creating original outputs
  </p>
</div>
...
<div style={{ textAlign: 'center' }}>
  <Image
    src="/images/Perplexity_Screenshot.webp" // Replace with your actual image path
    alt="Screenshot of Perplexity AI search engine results, demonstrating a generative AI response to a search query. Shows the search query and the AI-generated summary answer with cited sources."
    width={600} // Adjust width as needed - MUST BE SET EXPLICITLY
    height={400} // Adjust height as needed - MUST BE SET EXPLICITLY
    style={{ display: 'block', margin: '0 auto' }}
  />
  <p style={{ textAlign: 'center' }}>
    Screenshot of Perplexity AI search engine results, demonstrating a generative AI response to a search query. Shows the search query and the AI-generated summary answer with cited sources.
  </p>
</div>
...
<div style={{ textAlign: 'center' }}>
  <Image
    src="/images/GenAI_for_SEO.webp" // Replace with your actual image path
    alt="Infographic outlining potential applications of Generative AI in SEO, including content Generation, keyword research, on-page optimization, technical SEO, and link building."
    width={600} // Adjust width as needed - MUST BE SET EXPLICITLY
    height={400} // Adjust height as needed - MUST BE SET EXPLICITLY
    style={{ display: 'block', margin: '0 auto' }}
  />
  <p style={{ textAlign: 'center' }}>
    Infographic outlining potential applications of Generative AI in SEO, including content Generation, keyword research, on-page optimization, technical SEO, and link building.
  </p>
</div>
...
<div style={{ textAlign: 'center' }}>
  <Image
    src="/images/Digispot_keyword_screenshot.webp" // Replace with your actual image path
    alt="Screenshot of the Digispot AI Chrome extension, showing its content analysis feature. The extension analyzes a webpage and displays a list of relevant keywords with their frequency and percentage within the content."
    width={600} // Adjust width as needed - MUST BE SET EXPLICITLY
    height={400} // Adjust height as needed - MUST BE SET EXPLICITLY
    style={{ display: 'block', margin: '0 auto' }}
  />
  <p style={{ textAlign: 'center' }}>
    Screenshot of the Digispot AI Chrome extension, showing its content analysis feature. The extension analyzes a webpage and displays a list of relevant keywords with their frequency and percentage within the content.
  </p>
</div>
...
<div style={{ textAlign: 'center' }}>
  <Image
    src="/images/Digispot_alt_text_warning.webp" // Replace with your actual image path
    alt="Screenshot of Digispot AI's SEO Chrome extension interface, highlighting warnings for missing alt text on images and images lacking explicit dimensions. This illustrates common SEO issues related to images."
    width={600} // Adjust width as needed - MUST BE SET EXPLICITLY
    height={400} // Adjust height as needed - MUST BE SET EXPLICITLY
    style={{ display: 'block', margin: '0 auto' }}
  />
  <p style={{ textAlign: 'center' }}>
    Screenshot of Digispot AI's SEO Chrome extension interface, highlighting warnings for missing alt text on images and images lacking explicit dimensions. This illustrates common SEO issues related to images.
  </p>
</div>
...
<div style={{ textAlign: 'center' }}>
  <Image
    src="/images/Enhancing_SEO_with_GenAI.webp" // Replace with your actual image path
    alt="Infographic detailing various SEO enhancement strategies powered by Generative AI, covering areas like Human Editing, Content Originality, Keyword targeting, etc."
    width={600} // Adjust width as needed - MUST BE SET EXPLICITLY
    height={400} // Adjust height as needed - MUST BE SET EXPLICITLY
    style={{ display: 'block', margin: '0 auto' }}
  />
  <p style={{ textAlign: 'center' }}>
    Infographic detailing various SEO enhancement strategies powered by Generative AI, covering areas like Human Editing, Content Originality, Keyword targeting, etc.
  </p>
</div>
...
<div style={{ textAlign: 'center' }}>
  <Image
    src="/images/Benefits_of_SEO.webp" // Replace with your actual image path
    alt="Infographic illustrating the benefits of using Generative AI for SEO, such as large-scale content generation, increased content relevance, data-driven keyword discovery, and improved on-page optimization."
    width={600} // Adjust width as needed - MUST BE SET EXPLICITLY
    height={400} // Adjust height as needed - MUST BE SET EXPLICITLY
    style={{ display: 'block', margin: '0 auto' }}
  />
  <p style={{ textAlign: 'center' }}>
    Infographic illustrating the benefits of using Generative AI for SEO, such as large-scale content generation, increased content relevance, data-driven keyword discovery, and improved on-page optimization.
  </p>
</div>
